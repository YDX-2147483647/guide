...
- `$PATH`上还有`typst-0.13.1`、`typst-0.14.2`（或相应`*.exe`）可执行文件。（用于编译零星旧例子）
...
- `typst v0.13.1`、`typst v0.14.2`：使用指定旧版 typst 编译，并在网页上提示“并非最新版”

  若未提供`typst-0.13.1`等可执行文件，则仍使用最新版编译，同时在网页上提示“非正常编译”
